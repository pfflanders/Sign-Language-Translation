...
def move_class(dir1, dir2, dir_out, class_name):
    dir1_pics = sorted(glob(os.path.join(dir1, class_name, "*.png")))
    dir2_pics = sorted(glob(os.path.join(dir2, class_name, "*.png")))
    ...
    for i, pic in enumerate(all_pics):
        output_file = os.path.join(dir_out, class_name, f"{i}.png")
