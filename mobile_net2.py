...
from tensorflow.keras.layers import InputLayer, Flatten, Dense, ReLU, Softmax, Conv2D, Dropout,Lambda,AveragePooling2D
...
def main():
    ...
    model.load_weights(r'testing_models\mobilenet2\variables\variables')
